                        ...
                        <tbody>
                           <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" name="password" size="50" value ='<%=request.getAttribute("password") %>' type="password">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" name="repassword" size="50" value ='<%=request.getAttribute("password") %>' type="password">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" name="chinesename" size="50" value ='<%=request.getAttribute("chinesename") %>' type="text">   
                            ...
                            <tr>
                                <th>手机号码：</th>
                                <td>
                                    <input class="common-text" name="phonenumber" value ='<%=request.getAttribute("phonenumber") %>' size="50" type="text">
                            ...
                            <tr>
                                <th>电子邮件：</th>
                                <td>
                                    <input class="common-text" name="email" value ='<%=request.getAttribute("email") %>' size="50" type="text">
...
<!--                                <th>是否在职：</th>
                                <td>
                                    <input type="radio" name="isworker" value =<%=request.getAttribute("isworker") %>  />在职
                                    <input type="radio" name="isworker" value =<%=request.getAttribute("isworker") %> />离职
                                </td>
                            </tr>                          
-->                              
                            <tr>
