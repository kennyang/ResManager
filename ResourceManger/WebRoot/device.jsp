...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="devicelist.jsp">设备管理</a><span class="crumb-step">&gt;</span><span>新增作品</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="deviceOpt!add.action" method="post">
                    <table class="insert-tab" width="80%">
                        <tbody><tr>
                                <th><i class="require-red">*</i>设备名称：</th>
                                <td>
                                    <input class="common-text required"  name="devicename" size="50" type="text">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" name="ower" size="50" type="text">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" name="user" size="50" type="text">
